...
public class C_Login {
	...
	public boolean loginOk(String textoDoTxtLogin, String senha) {
		...
		if (u == null) {
			LaudoeCia.getTelaPrincipal().mostrarMensagemDeErro("Usuário não existente!", telaDeLogin);
			return false;
		} else {
			if (Objects.equals(u.getSenha(), senha)) {
				...
				LaudoeCia.getTelaPrincipal().mostrarMensagemDeErro("A senha está incorreta!", telaDeLogin);
				return false;
			}
		}
	}
