 ...
 */
public class PnlLayoutLaudoE5Img extends PnlLayoutImagens
{
    public PnlLayoutLaudoE5Img (LaudoeCiaMediator mediador)
    {
        super(mediador);
    }
    ...
    public MyJPanel definirLayout ()
    {
        ...
        pnlLaudo.setPreferredSize(new Dimension(350, 650));
        ...
        pnlImagens.add(Box.createVerticalStrut(20));
        pnlImagens.add(createItemLayout(151, 113, 4));
        pnlImagens.add(Box.createVerticalStrut(5));
        pnl.add(pnlImagens);
    ...
    /**
     * Gera HTML do layout laudo e 5 imagens.
    ...
    public String getHTML (int paginas)
    {
        ...
        sbTabelaImgs.append( "<tr><td style=\"padding-top: 3px\" align=\"center\" >");
        ...
        sbTabelaImgs.append( "<tr><td style=\"padding-top: 3px\" align=\"center\">");
        sbTabelaImgs.append(gerarImgHtmlTag(4,paginas,5));
        sbTabelaImgs.append("</td></tr>");
