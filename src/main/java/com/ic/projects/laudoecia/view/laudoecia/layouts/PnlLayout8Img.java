 ...
 */
public class PnlLayout8Img extends PnlLayoutImagens
{
    public PnlLayout8Img (LaudoeCiaMediator mediador)
    {
        super(mediador);
    }
    ...
    public MyJPanel definirLayout ()
    {
        ...
        pnlLinha1.add(createItemLayout(180, 135, 0));
        pnlLinha1.add(createItemLayout(180, 135, 1));
        pnl.add(pnlLinha1);
        pnl.add(Box.createVerticalStrut(20));

        MyJPanel pnlLinha2 = new MyJPanel(layoutLine);
        pnlLinha2.setBackground(Color.WHITE);
        pnlLinha2.add(createItemLayout(180, 135, 2));
        pnlLinha2.add(createItemLayout(180, 135, 3));
        pnl.add(pnlLinha2);
        pnl.add(Box.createVerticalStrut(20));

        MyJPanel pnlLinha3 = new MyJPanel(layoutLine);
        pnlLinha3.setBackground(Color.WHITE);
        pnlLinha3.add(createItemLayout(180, 135, 4));
        pnlLinha3.add(createItemLayout(180, 135, 5));
        pnl.add(pnlLinha3);
        pnl.add(Box.createVerticalStrut(20));

        MyJPanel pnlLinha4 = new MyJPanel(layoutLine);
        pnlLinha4.setBackground(Color.WHITE);
        pnlLinha4.add(createItemLayout(180, 135, 6));
        pnlLinha4.add(createItemLayout(180, 135, 7));
        pnl.add(pnlLinha4);
