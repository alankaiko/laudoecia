 ...
 */
public class PnlLayout6ImgGrandes extends PnlLayoutImagens {
	public PnlLayout6ImgGrandes(LaudoeCiaMediator mediador) {
		super(mediador);
	}
	...
	public MyJPanel definirLayout() {
		...
		pnlLinha3.add(createItemLayout(255, 191, 4));
		pnlLinha3.add(createItemLayout(255, 191, 5));
		pnl.add(pnlLinha3);
	...
	public String getHTML(int paginas) {
		...
		sb.append("<tr><td align=\"right\">");
		sb.append(gerarImgHtmlTag(4, paginas, 5));
		sb.append("</td><td align=\"left\">");
		sb.append(gerarImgHtmlTag(5, paginas, 5));
		sb.append("</td></tr>");
