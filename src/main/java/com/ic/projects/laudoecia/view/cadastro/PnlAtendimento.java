...
public class PnlAtendimento extends PnlDaEntidadeComCrud<Atendimento>
{
    ...
    public PnlAtendimento ()
    {
        ...
        add(new CampoDaEnt("Atendimento", false, false).setComponent(
                txtCodigo.pintarDeAmarelo(), true, false, false, true), c);
        c.gridx = 1;
        ...
        c.gridx = 8;
        c.gridwidth = 1;
        add(new CampoDaEnt(true, false).setComponent(btnBuscaConv
        ...
        c.gridx = 3;
        c.gridwidth = 1;
        add(new CampoDaEnt(true, true).setComponent(btnBuscaPac
                , false, true, false, false), c);
        c.gridx = 4;
        c.gridwidth = 2;
        ...
        c2.gridx = 4;
        c2.weightx = 1;
        pnlProfSol.add(new CampoDaEnt("Nome do prof. solicitante", true, true).setComponent(
                txtProfSol, false, true, true, true), c2);
        c.gridy = 2;
        c.gridx = 0;
        c.gridwidth = 9;
        add(pnlProfSol, c);
        ...
        pnlBtns.add(new CampoDaEnt(false, false, true)
                .setComponent(btnAddProc, false, false, true, true), c3);
        c3.gridx = 1;
        pnlBtns.add(new CampoDaEnt(false, true, true)
                .setComponent(btnEditProc, false, false, true, true), c3);
        c3.gridx = 2;
        pnlBtns.add(new CampoDaEnt(false, true, true)
                .setComponent(btnDelProc, false, false, true, true), c3);
        c3.weightx = 1;
        c3.gridx = 3;
        ...
        c3.gridx = 4;
        pnlBtns.add(new CampoDaEnt(false, true, true).
                setComponent(btnAtestado, true, true, false, true), c3);
        c3.gridx = 5;
        pnlBtns.add(new CampoDaEnt(false, true, true).
                setComponent(btnLaudo, true, true, false, true), c3);
        c3.gridx = 6;
        pnlBtns.add(new CampoDaEnt(false, true, true).
                setComponent(btnCaptura, true, true, false, true), c3);
        ...
        c.gridy = 5;
        c.weighty = 1d;
        add(new CampoDaEnt("Observações / Informações úteis", false, true).setComponent(
        ...
        c4.gridx = 5;
        pnlTotalPac.add(new CampoDaEnt(false, true, true).
                setComponent(txtTotalPac, false, true, false, true), c4);
    ...
    protected void configurarValidacao (Map<String, C_Validacao> validadores)
    {
        ...
        formValidator.add(txtPaciente, new RequiredFieldValidator(txtPaciente),
                                       new IValidaCampo() {
            ...
            public boolean validationOk (int tipo)
            {
                if (buscPac.getLinhaSelecionada() == null)
                {
                    return !controlador.pacienteExiste(
                        txtPaciente.getText(), txtDataNasc.getDate());
                }
                return true;
            }
            ...
            case 4:
                ...
                for (int i = 0; i < procedimentos.size(); i++)
                {
                    ...
                    linhasDaTabela.add(new Object[]
                            {
                                p,
                                p.getProfExecutante() == null ? 0 :
                                    p.getProfExecutante().getCodigo(),
                                p.getPrevEntregaLaudo(),
                                p.getValorPaciente()
                            });
                }
    ...
    public void usarResultadoDaBusca (Object o)
    {
        if (o instanceof Convenio)
        {
            ...
            {
                SwingUtils.mostrarMensagemDeErroConhecido(this, "O convênio "
                        + "está inativo");
            }
        }
    ...
    private ScrollResultsDaBusca scrpTabela = new ScrollResultsDaBusca(new TableConfigurator()
    {
        ...
        public String[] columnsTitles ()
        {
            return new String[]
                    {
                        "Procedimento médico", "Prof. ex.", "Prev. entrega", "Valor paciente"
                    };
        }
        ...
        public Class<?>[] columnsClasses ()
        {
            return new Class<?>[]
                    {
                        Object.class, Object.class, Date.class, Object.class
                    };
        }
...

    {
        ...
        btnBuscaConv.addActionListener(new ActionAddTela(
                TelaPrincipal.CADASTRO_CONVENIOS,
                new TelaSolPadrao(TelaPrincipal.ATENDIMENTO, txtConvenio),
                ...
                if (txtObservacoes.isEditable() && !mostrandoDadosDoPaciente)
                {
                    java.awt.EventQueue.invokeLater(new Runnable()
                    {
                        ...
                        public void run ()
                        {
                            ...
                            {
                                mostrarAviso("Alerta: já existe um atendimento "
                                        + "cadastrado para esse paciente "
                                        + "com a data de hoje!");
                            }
                        }
        ...
        btnBuscaPac.addActionListener(new ActionAddTela(
                TelaPrincipal.CADASTRO_PACIENTES,
                new TelaSolPadrao(TelaPrincipal.ATENDIMENTO, txtPaciente),
                new AdapterPermissaoDeUsuario()
                {
                    @Override
                    public boolean podeAcessar (PerfilDeAcesso p)
        ...
        btnLaudo.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent e)
            {
                if (validarBtnLaudoECaptura())
                {
                    ...
                    PnlLaudoeCia.getInstance().abrirModuloDeLaudo(
                            ultimoAtdMostrado, procSel());
                    LaudoeCia.getTelaPrincipal().setCursorToDefaultCursor();
                }
            }
        ...
        btnCaptura.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed (ActionEvent e)
            {
                if (validarBtnLaudoECaptura())
                {
                    ...
                    FormPrincipal.getInstance().mostrarTela(
                            TelaPrincipal.LAUDO_E_CAPTURA, new TelaSolicitanteNull());
                    PnlLaudoeCia.getInstance().abrirModuloDeCaptura(
                            ultimoAtdMostrado, procSel());
                    LaudoeCia.getTelaPrincipal().setCursorToDefaultCursor();
                }
            }
    ...
    private void btnAddProcAction ()
    {
        ...
        else
        {
            ...
            try
            {
                ...
                if (conv == null)
                {
                    SwingUtils.mostrarAviso(null, "É preciso selecionar"
                                                  + " um convênio primeiro.");
                }
                else
                {
                    ...
                    if (!d.isCancelado())
                    {
                        ...
                        if (validaUnicidadeProcedimento(d.getProcDaTabela()))
                        {
                            ...
                            dados[0] = proc;
                            dados[1] = proc.getProfExecutante() == null ? 0
                                       : proc.getProfExecutante().getCodigo();
    ...
    private void buscarSolAction ()
    {
        ...
        if (!dlgSol.isCancelado())
        {
            ...
            else if (solicitante.getNumNoConselho() == null ||
                solicitante.getNumNoConselho().trim().isEmpty())
            {
        ...
        else if (validaUnicidadeProcedimento(d.getProcDaTabela()))
        {
            if (proc.getLaudo() == null)
            {
                return true;
                     ...
                     + " exame será original será perdido, mas não as imagens."
                     + " Deseja continuar?", this) == JOptionPane.YES_OPTION)
            {
                proc.setLaudo(null);
                return true;
            }
    ...
    private void btnDelProcAction ()
    {
        ...
        if (selectedResult != null && SwingUtils.obterConfirmacaoDoUsuario(
          ...
          + "Continuar?", this) == JOptionPane.YES_OPTION)
        {
    ...
    private void mostrarIdadeOssea (Paciente p)
    {
        ...
        {
            janela.setTitulo("Atendimento " + txtCodigo.getText() +
                      ": " + p.getNome() + ", " + p.getIdadeOssea());
        }
    }
    ...
    private boolean procIsLocked (int codigo)
    {
        ...
        mostrarAviso("O procedimento não pode ser alterado porque ele está "
                + "aberto na estação " + est.getNomeEstacaoDeTrabalho());
        return true;
    }
            ...
            else
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < procs.size(); i++)
                    {
                        ...
                        p.setValorConvenio(pdt.getValorNoConvenio().
                                getValorNoConvenio().doubleValue());
...
SWITCH:         switch (restricaoSexo)
    ...
    private class DlgSolicitante extends MyJDialog
    {
        ...
        private Container criarContentPane ()
        {
            ...
            c.gridx = 2;
            c.weightx = 1;
            pnl.add(new PnlComp("Núm. no conselho ou nome do solicitante",
                    true, true).setComponent(txtBusca), c);
            ...
            btnOk.addActionListener(new ActionListener() {
                ...
                public void actionPerformed (ActionEvent e)
                {
                    if (scroll.getSelectedResult() == null)
                    {
                        ...
                        {
                            SwingUtils.mostrarAviso(DlgSolicitante.this, ""
                    ...
                    {
                        solicitante = buscProfSol.getModel(new Object[] {
                            cmbConselho.getSelectedItem(), cmbUF.getSelectedItem(),
        ...
        private class MeuSw extends SwingWorker<List<Object[]>, Void>
        {
            ...
            protected List<Object[]> doInBackground () throws Exception
            {
                ...
                if (!isCancelled())
                {
                    r.addAll(buscProfSol.buscarNumENome(cmbConselho.getSelectedItem()
                            , cmbUF.getSelectedItem(), textoBusca));
                }
                return r;
            }
