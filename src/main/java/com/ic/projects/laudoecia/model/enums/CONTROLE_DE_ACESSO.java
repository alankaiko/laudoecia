...
public enum CONTROLE_DE_ACESSO {
	//Alterado dia 22/01/2021 - solicitado pra exigir senha pra todo mundo
	...
	//CLASSE ControladorDeAcesso ==> METODO getInstance() comentado as linhas
	
	//package com.ic.projects.laudoecia.model.auditable;
	//CLASSE ParametrosDoSistema LINHA 111
	
	//package com.ic.projects.laudoecia.view.cadastro;
	//CLASSE PnlParametrosDoSistema linha 881
